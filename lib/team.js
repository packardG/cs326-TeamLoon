...
var team = [
	...
	member('jdoe', 'John', 'Doe', 'Senior', 'This is jdoe'),
	member('acbentle', 'Aaron', 'Bentley', 'Senior', ''),
	member('pgilson', 'Packard', 'Gilson', 'Junior', ''),
	member('pjmcd0', 'Patrick', 'McDonough', 'Senior', ''),
	member('pjhurley', 'Patrick', 'Hurley', 'Junior', ''),
	member('tdaigle', 'Timothy', 'Daigle', 'Senior', ''),
	member('tdng', 'Timothy', 'Ng', 'Senior', 'This is the profile of Timothy Ng')
];
